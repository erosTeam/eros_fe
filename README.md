# Eros-FE
English | [简体中文](https://github.com/erosTeam/eros_fe/blob/master/README_cn.md)
...
1. Get the ipa file from [Releases](https://github.com/erosTeam/eros_fe/releases/latest).
